...
export default function Projects({ projects }: Props) {
  return (
    <motion.div
      ...
      className="h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0 group px-2"
    >
        ...
        {projects.map((project, i) => (
          ...
          >
            <motion.img
              ...
              alt=""
              className="max-w-screen max-h-[275px] md:max-h-[400px] object-contain"
            />
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p className="text-lg text-center md:text-left max-w-lg w-screen">
                {project.summary}
              </p>
            </div>
          </div>
